...
for vlen in 128 256 512; do
  echo "--- vlen=$vlen ---"
  for t in depthwise_float_accuracy_test depthwise_int8_accuracy_test depthwise_uint8_accuracy_test gemm_float_accuracy_test gemm_int8_accuracy_test gemm_uint8_accuracy_test; do
    echo "  > $t"
